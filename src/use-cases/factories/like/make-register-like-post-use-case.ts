...
import { RegisterLikeUseCase } from "@/use-cases/likes/register-like-post"


export function makeRegisterLikeUseCase(){
    const likesRepository = new PrismaLikesRepository()
    const usuariosRepository = new PrismaUsuariosReporistory()
    const postsRepository = new PrismaPostsRepository()
    
    const registerLikeUseCase = new RegisterLikeUseCase(likesRepository, usuariosRepository, postsRepository)
